...
export const fileStructure = {
  ...
  hooks: {
    useStudentData: '/src/app/hooks/useStudentData.ts',
    useSmartPopup:  '/src/app/hooks/useSmartPopupPosition.ts',
  },

  /** Componentes — layout */
  layout: {
    Layout:              '/src/app/components/layout/Layout.tsx',             // Shell principal: sidebar + header + content
  ...
  views: {
    ...
    HomeView:             '/src/app/components/content/HomeView.tsx',             // (legacy, replaced by WelcomeView)
    ModelViewer3D:        '/src/app/components/content/ModelViewer3D.tsx',        // Viewer 3D (three.js/R3F)
    LessonGridView:       '/src/app/components/content/LessonGridView.tsx',      // Grid de lecciones
  },
...
export const stateManagement = {
  ...
  /** Patron de Provider wrapping en App.tsx */
  providerTree: `
    <AppProvider>
      <StudentDataProvider>
        <Layout />
...
export const navigationFlow = {
  ...
  method: 'AppContext.setActiveView(viewId)',

  /** Todas las vistas disponibles */
  viewTypes: [
    'home',               // WelcomeView — pagina principal
  ...
  /** Layout rendering: Layout.tsx > renderContent() > switch(activeView) */
  renderFlow: 'Layout.tsx usa un switch(activeView) para montar la vista correspondiente',
