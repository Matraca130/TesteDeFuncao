...
export function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f2ea] flex flex-col items-center justify-center p-4 sm:p-8">
      ...
      <div className="mt-8 text-center"><div className="inline-flex items-center gap-2 bg-white/80 border border-gray-200 rounded-full px-4 py-2">
        <GraduationCap size={14} className="text-amber-500" /><p className="text-xs text-gray-500">Alunos: acesse pelo link da sua instituicao <span className="text-gray-400">(/i/slug)</span></p>
      </div></div>
