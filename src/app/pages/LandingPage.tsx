  ...
  return (
    <div className="min-h-screen bg-[#f5f2ea] flex flex-col items-center justify-center p-4 sm:p-8">
      ...
      <div className="w-full max-w-md space-y-3">
        ...
        >
          ...
          <div className="flex-1">
            <h3 className="text-sm font-semibold text-gray-900">Admin / Owner</h3>
            <p className="text-xs text-gray-500">Gerencie sua instituicao e conteudo</p>
          </div>
        ...
        >
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-gray-500">Crie e gerencie resumos e conteudo</p>
          </div>
      ...
      <div className="mt-8 text-center">
        <div className="inline-flex items-center gap-2 bg-white/80 border border-gray-200 rounded-full px-4 py-2">
          ...
          <p className="text-xs text-gray-500">
            Alunos: acesse pelo link da sua instituicao <span className="text-gray-400">(/i/slug)</span>
          </p>
        </div>
      </div>
      ...
      <p className="text-xs text-gray-400 mt-10">
        Axon v4.4 — Plataforma educacional medica
      </p>
    </div>
  );
}
