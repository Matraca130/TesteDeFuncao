...
export function UserProfileDropdown() {
  ...
  const displayName = isConnected && profile ? profile.name : 'Dr. Estudante';
  const displayEmail = isConnected && profile ? profile.email : 'estudante@axon.med.br';
  const displayShortName = isConnected && profile ? profile.name.split(' ')[0] : 'Dr. Estudante';
      ...
      <div className="relative">
        ...
        >
          <div className="text-right hidden md:block">
            ...
            <p className="text-[10px] text-teal-400/70 font-medium tracking-wide uppercase">Premium</p>
          </div>
          <div className="relative">
            <img
        ...
        <AnimatePresence>
          {isOpen && (
            ...
            >
              ...
              <div className="relative px-4 pt-4 pb-3 overflow-hidden">
                ...
                <div className="relative flex items-center gap-3">
                  ...
                  <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded-full bg-teal-500/20 border border-teal-500/20 shrink-0">
                    ...
                    <span className="text-[9px] font-semibold text-teal-300 uppercase tracking-wider">Pro</span>
                  </span>
                </div>
              </div>
              ...
              {/* ── Logout ── */}
              <div className="p-1.5">
                <button className="w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-red-400/80 hover:text-red-400 hover:bg-red-500/[0.08] transition-all">
                  <LogOut size={15} />
