...
import { kpiCardClasses, iconBadgeClasses } from '@/app/design-system';
    ...
    <div className="h-full flex flex-col bg-surface-dashboard">
      ...
      <div className="shrink-0">
        <AxonPageHeader
          ...
          actionButton={
            <button
              onClick={() => setActiveView('review-session')}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            <div className="flex items-start justify-between mb-4">
              ...
              <div className={`flex items-center gap-1 text-xs font-semibold px-2 py-1 rounded-full ${components.kpiCard.trend.up}`}>
                <TrendingUp size={12} /> {STATS.masteredTrend}
              </div>
            </div>
            <div>
              <p className="text-sm font-medium text-gray-500 mb-1">Cards Dominados</p>
              <h3 className="text-2xl font-bold text-gray-900">{effectiveStats.totalMastered.toLocaleString()}</h3>
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-start justify-between mb-4">
              ...
              <span className="text-xs font-semibold text-teal-700">{effectiveStats.todayDone}/{effectiveStats.todayLoad}</span>
            </div>
            <div>
              <p className="text-sm font-medium text-gray-500 mb-1">Carga de Hoje</p>
              <h3 className="text-2xl font-bold text-gray-900">{effectiveStats.todayLoad}</h3>
            </div>
          ...
          >
            <div className="flex items-start justify-between mb-4">
              ...
              <div className={`flex items-center gap-1 text-xs font-semibold px-2 py-1 rounded-full ${components.kpiCard.trend.up}`}>
                <CheckCircle2 size={12} /> Ótimo
              </div>
            </div>
            <div>
              <p className="text-sm font-medium text-gray-500 mb-1">Taxa de Retenção</p>
              <h3 className="text-2xl font-bold text-gray-900">{effectiveStats.avgRetention}%</h3>
            </div>
          </motion.div>
        </div>
