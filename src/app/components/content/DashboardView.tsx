          ...
          <div className="flex bg-white rounded-lg p-1 shadow-sm border border-gray-200/60 shrink-0">
            <button
              ...
              className={clsx(
                ...
                timeRange === 'week' ? "bg-teal-500 text-white shadow-sm" : "text-gray-500 hover:text-gray-700"
              )}
            >
              Esta Semana
            </button>
            <button
              ...
              className={clsx(
                "px-4 py-2 text-sm font-medium rounded-md transition-all",
                timeRange === 'month' ? "bg-teal-500 text-white shadow-sm" : "text-gray-500 hover:text-gray-700"
              )}
            >
              Este Mês
            </button>
      ...
      <div className="px-6 py-6 bg-surface-dashboard">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <KPICard 
            ...
            value={kpiStreak}
            trend={isConnected && stats && stats.currentStreak >= stats.longestStreak ? "Recorde!" : `Melhor: ${stats?.longestStreak ?? 23}`}
            trendUp={true}
            color="bg-amber-50"
          />
          <KPICard 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <motion.div 
            ...
            className="lg:col-span-2 bg-white rounded-2xl p-6 shadow-[0_2px_8px_rgba(0,0,0,0.04)] border border-gray-100 min-w-0"
          >
          ...
          <motion.div 
            ...
            className="bg-white rounded-2xl p-6 shadow-[0_2px_8px_rgba(0,0,0,0.04)] border border-gray-100 min-w-0"
          >
...
function KPICard({ 
  ...
  return (
    <div className="bg-white p-5 rounded-2xl shadow-[0_2px_8px_rgba(0,0,0,0.04)] border border-gray-100 hover:shadow-md transition-all">
