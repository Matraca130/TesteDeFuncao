...
import type { Course, Semester, Section, Topic, Summary, Keyword, SubTopic, ApprovalItem, ContentStatus } from './lib/types';

// ── View types ──
type AdminView = 'overview' | 'courses' | 'content-tree' | 'summaries' | 'keywords' | 'approval';
