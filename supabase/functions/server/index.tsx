// ============================================================
// Axon v4.4 — Figma Make Server Entry Point (Compositor)
// Mounts ALL 12 route modules (same as index.ts) with the
// Figma Make prefix: /make-server-ae4c3d80
//
// IMPORTANT: This file was a 32KB monolith that duplicated all
// route logic inline. Refactored to import from modular files.
// ============================================================
...
// Route modules (shared with index.ts)
...
app.get(`${PREFIX}/health`, (c) => {
  return c.json({
    ...
    version: "4.4",
    prefix: PREFIX,
    entrypoint: "index.tsx (Figma Make)",
    keys_aligned: "kv-keys.ts",
    routes: [
      "auth", "institutions", "content", "canvas", "dashboard", "flashcards",
      "quiz", "reading", "reviews", "sessions", "model3d", "ai", "seed",
    ],
  });
});
...
// ── Inline seed (FSRS flashcards — same as index.ts) ─────────
